...
import { X, ChevronRight, Clock, Loader2, Check } from "lucide-react";
...
export function RescheduleCalendarStep({ 
  professional, 
  appointmentId,
  onComplete, 
  onClose 
}: RescheduleCalendarStepProps) {
  ...
  const handleReschedule = async () => {
    ...
    try {
      ...
      toast.error("Error al reagendar la cita. Inténtalo de nuevo.");
    }
  };
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="sticky top-0 bg-background/95 backdrop-blur-lg z-10 px-6 pt-6 pb-4 border-b border-border">
        <div className="flex items-center justify-between mb-4">
          <div className="w-10" />
          <span className="text-sm text-muted-foreground">Reagendar cita</span>
